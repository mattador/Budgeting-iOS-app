...
//  sugarmamma
//
//  Created by Matthew Cooper on 25/5/17.
...
class CalendarView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var events : [FinancialEventModel]? {
        ...
        didSet {
            ...
            for event in events {
                ...
                let calEvent = CalendarEvent(title: event.event_name!, startDate: startDate! as Date, endDate: endDate! as Date)
    ...
    override init(frame: CGRect) {
        super.init(frame: CGRect(x: 0.0, y: 0.0, width: frame.size.width, height: frame.size.height))
        self.createSubviews()
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //@todo Check why I couldn't figure out a way to allow users to re-enter
        dayCell.isSelected = false //selectedIndexPaths.contains(indexPath)
